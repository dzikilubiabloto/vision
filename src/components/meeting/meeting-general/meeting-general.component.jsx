  ...
  return (
    <div className="grey meeting-tab-content">
      ...
      <ul>
        <li>
          <span>
            a <strong>connecting</strong> space where we share our stories and
            what is our dream;
          </span>
        </li>
        <li>
        ...
        <li>
          <span>
            <strong>creativity</strong> space where we develop new ideas of what
        ...
        <li>
          <span>
            ...
            (e.g. create vision, choose decision making process, deciding how we
            are dealing with conflicts)
          </span>
        </li>
      </ul>
    </div>
